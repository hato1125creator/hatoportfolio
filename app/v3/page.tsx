    ...
    <main className={styles.page} id="top">
      ...
      <section className={styles.qr} id="qr">
        ...
        <div className={styles.qrUi}>
          <div className={styles.qrUiText}>
            ...
            <ol>
              <li><b>01</b>学校メールで認証</li><li><b>02</b>招待者を登録</li><li><b>03</b>招待リンク・QR発行</li><li><b>04</b>複数端末で受付</li><li><b>05</b>入場記録・集計</li>
            </ol>
          </div>
      ...
      <section className={styles.works} id="works">
        ...
        <article className={styles.portal}>
          ...
          <div className={styles.portalFlow}><figure><img src="/evidence/portal-home-mobile.png" alt="提出ポータルの入口" /><figcaption>入口</figcaption></figure><figure><img src="/evidence/portal-form.jpeg" alt="書類提出画面" /><figcaption>提出</figcaption></figure><figure className={styles.portalAdmin}><img src="/evidence/portal-admin.jpeg" alt="提出状況の管理画面" /><figcaption>審査・進捗</figcaption></figure></div>
        </article>
        <article className={styles.festival}>
          <div className={styles.festivalVisual}><div className={styles.browserBar}><span></span><span></span><span></span><b>梨花祭2026 特設Webサイト</b></div><iframe src="https://rikasai2026-site-tokusetu.vercel.app/" title="梨花祭2026 特設Webサイト" loading="lazy" /></div>
        ...
        <article className={styles.discord}>
          ...
          <div className={styles.discordVisuals}><figure className={styles.discordMain}><img src="/evidence/discord-channel-structure.png" alt="Discordのチャンネル構成" /><figcaption>チャンネル構成</figcaption></figure><figure className={styles.discordSub}><img src="/evidence/discord-project-forum.png" alt="Discordのフォーラム" /><figcaption>フォーラム運用</figcaption></figure></div>
        </article>
      </section>
      ...
      <section className={styles.musashi} id="musashi">
        ...
        <div className={styles.researchQuestion}><span>具体的に深めたい学び</span><p><b>新井庭子ゼミ ─ 情報の可視化と調査</b><br /><small>テキストマイニングやデータの可視化を通して、住民の意見や情報への接触状況を分析し、「誰に何が届いていないのか」を確かめ、その結果を情報設計へ戻す方法を学びたい。</small></p></div>
      ...
      <section className={styles.credits} id="credits">
        ...
        <div className={styles.creditGrid}><div><b>越川颯人</b><p>課題発見、企画、要件決定、画面・運用設計、実装、関係者との調整、最終判断を担当。</p></div><div><b>AI支援</b><p>ChatGPT・Claude Codeを、コード案、エラー調査、要件と文章の整理に使用。出力は本人が確認・修正した。</p></div><div><b>共同運用・素材</b><p>受付や審査、安全管理は生徒会・実行委員・教員と共同で運用。特設サイトのモチーフイラストは別の生徒が制作した。</p></div></div>
      </section>

      <footer className={styles.footer}><div><b>越川颯人</b><span>千葉英和高等学校 / 2026</span></div><div><a href="/presentation">発表用表示</a><a href="#top">ページ上部へ ↑</a></div></footer>
    </main>
  );
}
